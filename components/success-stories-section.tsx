...
export function SuccessStoriesSection() {
  ...
  return (
    <section id="testimonios" className="py-20 bg-slate-50 border-t border-slate-100">
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between mb-12">
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-slate-600">
                La tranquilidad de saber que estás en manos de expertos. Así lo vivieron ellos:
              </p>
            </div>
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4">
                  <div className={`w-10 h-10 rounded-full ${testimonial.color} text-white flex items-center justify-center font-bold text-lg shadow-sm`}>
                      {testimonial.initial}
                  </div>
                  <div>
        ...
        <AnimateOnScroll direction="up" delay={0.2}>
          <div className="flex flex-col items-center justify-center mt-8 gap-6">
             ...
             <div className="flex md:hidden gap-4">
                <button onClick={() => handleScroll("left")} className="p-3 rounded-full border border-gray-300 bg-white shadow-sm active:scale-95 transition-transform">
                    <FaChevronLeft />
                </button>
                <button onClick={() => handleScroll("right")} className="p-3 rounded-full border border-gray-300 bg-white shadow-sm active:scale-95 transition-transform">
                    <FaChevronRight />
                </button>
             </div>
            ...
            >
              ...
              <svg className="w-4 h-4 text-[#002654] group-hover:translate-x-0.5 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
